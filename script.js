            ...
            if (!hasErrors) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        successMessage.style.cssText = 'color: #38a169; padding: 1rem; background: #f0fff4; border-radius: 0.375rem; margin-top: 1rem;';
                        contactForm.reset();
                ...
                .catch(() => {
                    ...
                    errorMessage.style.cssText = 'color: #e53e3e; padding: 1rem; background: #fff5f5; border-radius: 0.375rem; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '474312f6-575e-4391-bece-e40b181b7233',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '474312f6-575e-4391-bece-e40b181b7233';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '474312f6-575e-4391-bece-e40b181b7233';
